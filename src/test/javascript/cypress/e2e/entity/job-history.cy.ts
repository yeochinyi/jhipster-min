...
describe('JobHistory e2e test', () => {
  ...
  describe('new JobHistory page', () => {
    ...
    it('should create an instance of JobHistory', () => {
      cy.get(`[data-cy="startDate"]`).type('2022-10-25T23:05').blur().should('have.value', '2022-10-25T23:05');

      cy.get(`[data-cy="endDate"]`).type('2022-10-25T06:02').blur().should('have.value', '2022-10-25T06:02');
